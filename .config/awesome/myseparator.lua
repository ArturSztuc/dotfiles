...
-- Lain Cairo myseparator util submodule
-- lain.util.myseparator
local myseparator = { height = 0, width = 9 }

-- [[ Arrow

-- Right
function myseparator.arrow_right(col1, col2)
    local widget = wibox.widget.base.make_widget()
    widget.col1 = col1
    widget.col2 = col2

    widget.fit = function(m, w, h)
        return myseparator.width, myseparator.height
    end
...
-- Left
function myseparator.arrow_left(col1, col2)
    local widget = wibox.widget.base.make_widget()
    widget.col1 = col1
    widget.col2 = col2
